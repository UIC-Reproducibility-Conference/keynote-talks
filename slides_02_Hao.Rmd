...
# Learning Communities for Core Skills

---
layout: true
class: split-three

.row.bg-blue1[.split-two[
...
.row.bg-blue2[.split-two[
  ...
  .column[.content.vmiddle[
    ...
    [ReproHack Hub launch Nov 18](https://www.reprohack.org/event/11/)
  ]]
]]
.row.bg-blue3[.split-two[
  .column[.content.vmiddle[
...
.row.bg-blue3[.split-two[
  ...
  .column[.content.vmiddle[
    best practices for better research software
  ]]
]]
---
count: false
...
1. There are many areas to focus on and different scales of change. Pick one!
